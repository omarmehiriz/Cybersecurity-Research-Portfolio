...
* **[Module 02: Chromium Cookie Forensics](./02-Chromium-Cookie-Forensics)**: Investigación sobre el descifrado de AES-GCM, bypass de bloqueos de bases de datos y secuestro de sesiones (Session Hijacking).
